...
var data = {
  ...
  FooterLinkLists: [{
    ...
    FooterLinkList: [{ name: 'Privacy Policy', link: '/help/about-nypl/legal-notices/privacy-policy', className: 'footer1' }, { name: 'Other Policies', link: '/policies' }, { name: 'Terms & Conditions', link: '/terms-conditions' }, { name: 'Governance', link: '/help/about-nypl/leadership/board-trustees' }],
    ulClass: ''
  }, {
    FooterLinkList: [{ name: 'Rules & Regulations', link: '/help/about-nypl/legal-notices/rules-and-regulations', className: 'footer1' }, { name: 'Accessibility', link: '/help/community-outreach/services-for-persons-with-disabilities' }, { name: 'Language', link: '/language' }],
    ulClass: 'last'
  }]
};
