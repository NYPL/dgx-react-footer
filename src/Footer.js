      ...
      <footer id={this.props.id} className={this.props.className}>
        <div id={`${this.props.id}-content`}
          className={`${this.props.className}-content`}>
            ...
            <li><a href="/help/about-nypl">About NYPL</a>
            <ul>
            ...
            <li><a href="/help/about-nypl/legal-notices/privacy-policy">Privacy Policy</a>
            <ul>
            ...
            <li><a href="/help/about-nypl/legal-notices/rules-and-regulations">Rules & Regulations</a>
            <ul>
